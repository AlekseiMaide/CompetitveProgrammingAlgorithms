/* 
 * Reference: https://www.nayuki.io/page/convex-hull-algorithm
 *
 *
...
vector<Point> makeConvexHull(std::vector<Point> points);

// Returns the convex hull, assuming that each points[i] <= points[i + 1]. Runs in O(n) time.
vector<Point> makeConvexHullPresorted(const std::vector<Point> &points);
...
// Todo: Implement function to check if within bounds of a convex hull.
//      Check if a point is to the left of the generated convex hull.